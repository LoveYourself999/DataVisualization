...
public class Expenditure_Percent_Of_GDP_Observer extends Observer {

    private String methodCode = "SH.XPD.CHEX.GD.ZS";
    private String ObserverDes = "Current health expenditure (% of GDP)";

    public Expenditure_Percent_Of_GDP_Observer(Subject subject){
