...
public class Expenditure_Health_Pre1000_Observer extends Observer {

    private String methodCode = "SH.XPD.CHEX.PC.CD";
    private String ObserverDes = "Current health expenditure per 1000 (current US$) ";

    public Expenditure_Health_Pre1000_Observer(Subject subject){
