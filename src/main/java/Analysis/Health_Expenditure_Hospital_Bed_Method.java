...
import Analysis_Observer.Expenditure_Health_Pre1000_Observer;
import Analysis_Observer.Hospital_Bed_Observer;
...
public class Health_Expenditure_Hospital_Bed_Method implements AnalysisStrategy {

    private String AnalysisInfo = "Health_Expenditure_Hospital_Bed_Method";
    ...
    public void initialize_Des_List() {
        des_List.add("ratio of " + method_list.get(0) + " / " + method_list.get(1) );
    ...
    public Health_Expenditure_Hospital_Bed_Method(Chart chart, String countryName, int startYear, int endYear) {
        super();
    ...
    public void analyze() {
        ...
        new Expenditure_Health_Pre1000_Observer(subject);
        new Hospital_Bed_Observer(subject);
        StringBuilder sb = new StringBuilder();
        sb.append("Current health expenditure (per 1,000 people) & Hospital beds (per 1,000 people) " +
                " \n" + "==============================\n");
        ...
        for(int i = 0; i< size ; i++)
        {
            ...
            {
                double ratio = temp_data1.get(i).getValue()/temp_data2.get(i).getValue();
...
//    {
//          Data_Fetcher df = new Data_Fetcher("CAN",2001,2010,"Health Expenditure Hospital Bed Method","report");
//
//    }
