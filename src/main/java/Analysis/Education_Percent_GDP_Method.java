...
public class Education_Percent_GDP_Method implements AnalysisStrategy {

    private String AnalysisInfo = "Education_Percent_GDP_Method";
    ...
    public Education_Percent_GDP_Method(Chart chart, String countryName, int startYear, int endYear) {
        super();
    ...
    public void analyze() {
        ...
        sb.append("Education_Percent_GDP_Method \n" + "==============================\n");
    ...
    public String return_name() {
        return "Education_Percent_GDP_Method";
    }


//    public static void main(String args[])
//    {
//          Data_Fetcher df = new Data_Fetcher("CAN",2001,2010,"Education Percent GDP Method","Pie chart");
//
//    }
