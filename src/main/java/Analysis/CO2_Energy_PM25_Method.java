...
public class CO2_Energy_PM25_Method implements AnalysisStrategy {

    private String AnalysisInfo = "CO2_Energy_PM25_Method";
    ...
    public CO2_Energy_PM25_Method(Chart chart, String countryName, int startYear, int endYear) {
        super();
    ...
    public void analyze() {
        ...
        new Energy_Use_Observer(subject);
        new Pm25_Observer(subject);
        StringBuilder sb = new StringBuilder();
        sb.append("CO2_Energy_PM25_Method \n" + "==============================\n");
...
//    {
//          Data_Fetcher df = new Data_Fetcher("CAN",2001,2020,"CO2 Energy PM25 Method","report");
//
//    }
