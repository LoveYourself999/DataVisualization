...
public class CO2_Energy_PM25_MethodTest {

    @Test
    public void initialize_Des_List_00() {
        Data_Fetcher df = new Data_Fetcher("CAN",2001,2020,"CO2 Energy PM25 Method","Scatter Chart");
       // assertTrue(df.getMethod().returnAnalysisInfo().equals("CO2_Energy_PM25_Method"));
