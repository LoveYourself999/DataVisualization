...
public class Education_Percent_GDP_And_Health_MethodTest {

    @Test
    public void initialize_Des_List_00() {
        Data_Fetcher df = new Data_Fetcher("USA",2001,2020,"Education Percent GDP And Health Method","Report");
        assertTrue(df.getMethod().returnAnalysisInfo().equals("Education_Percent_GDP_And_Health_Method"));
