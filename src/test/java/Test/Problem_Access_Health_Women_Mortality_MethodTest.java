...
public class Problem_Access_Health_Women_Mortality_MethodTest {

    @Test
    public void initialize_Des_List_00() {
        Data_Fetcher df = new Data_Fetcher("CHN",2001,2020,"Problem Access Health Women Mortality Method","Line chart");
        assertTrue(df.getMethod().returnAnalysisInfo().equals("Problem_Access_Health_Women_Mortality_Method"));
    ...
    public void add_to_chart_00() {
        Data_Fetcher df = new Data_Fetcher("CHN",2001,2020,"Problem Access Health Women Mortality Method","Report");
