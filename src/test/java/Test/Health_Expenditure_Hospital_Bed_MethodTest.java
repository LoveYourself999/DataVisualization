...
public class Health_Expenditure_Hospital_Bed_MethodTest{

    @Test
    public void initialize_Des_List_00() {
        Data_Fetcher df = new Data_Fetcher("CHN",2001,2020,"Health Expenditure Hospital Bed Method","Report");
        assertTrue(df.getMethod().returnAnalysisInfo().equals("Health_Expenditure_Hospital_Bed_Method"));
