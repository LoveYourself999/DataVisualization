...
public class CO2_GDP_MethodTest {

    @Test
    public void initialize_Des_List_00() {
        Data_Fetcher df = new Data_Fetcher("CAN",2001,2020,"CO2 GDP Method","Bar chart");
        assertTrue(df.getMethod().returnAnalysisInfo().equals("CO2_GDP_Method"));
    ...
    public void add_to_chart_00() {
        Data_Fetcher df = new Data_Fetcher("CAN",2001,2020,"CO2 GDP Method","Report");
